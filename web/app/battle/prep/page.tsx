      ...
      <div style={{ maxWidth: '560px', margin: '0 auto', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
          ...
          <div style={{ flex: 1, textAlign: 'center', padding: '0.75rem', background: 'rgba(163,45,45,0.08)', border: '1px solid rgba(163,45,45,0.2)', borderRadius: '10px' }}>
            <div style={{ fontSize: '0.7rem', color: '#6b5c80', letterSpacing: '0.1em', marginBottom: '4px' }}>OPPONENT</div>
            <div style={{ fontSize: '1rem', color: '#e8e0f0', fontWeight: 600 }}>{opponentName || 'Unknown'}</div>
            <div style={{ fontFamily: '"Crimson Text", serif', color: '#E24B4A', fontSize: '0.9rem' }}>{opponentPower.toLocaleString()} power</div>
          </div>
        </div>
